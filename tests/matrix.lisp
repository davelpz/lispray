...
(deftest matrix-transform
  (let ((tr (translation 5.0d0 -3.0d0 2.0d0))
...
(deftest matrix-shearing
  (let* ((p (tuples:make-point 2.0d0 3.0d0 4.0d0))
         (transform (shearing 1.0d0 0.0d0 0.0d0 0.0d0 0.0d0 0.0d0))
         )
    (ok (tup-eql (mul-tup transform p) (tuples:make-point 5.0d0 3.0d0 4.0d0)))
    )
  (let* ((p (tuples:make-point 2.0d0 3.0d0 4.0d0))
         (transform (shearing 0.0d0 1.0d0 0.0d0 0.0d0 0.0d0 0.0d0))
         )
    (ok (tup-eql (mul-tup transform p) (tuples:make-point 6.0d0 3.0d0 4.0d0)))
    )
  (let* ((p (tuples:make-point 2.0d0 3.0d0 4.0d0))
         (transform (shearing 0.0d0 0.0d0 1.0d0 0.0d0 0.0d0 0.0d0))
         )
    (ok (tup-eql (mul-tup transform p) (tuples:make-point 2.0d0 5.0d0 4.0d0)))
    )
  (let* ((p (tuples:make-point 2.0d0 3.0d0 4.0d0))
         (transform (shearing 0.0d0 0.0d0 0.0d0 1.0d0 0.0d0 0.0d0))
         )
    (ok (tup-eql (mul-tup transform p) (tuples:make-point 2.0d0 7.0d0 4.0d0)))
    )
  (let* ((p (tuples:make-point 2.0d0 3.0d0 4.0d0))
         (transform (shearing 0.0d0 0.0d0 0.0d0 0.0d0 1.0d0 0.0d0))
         )
    (ok (tup-eql (mul-tup transform p) (tuples:make-point 2.0d0 3.0d0 6.0d0)))
    )
  (let* ((p (tuples:make-point 2.0d0 3.0d0 4.0d0))
         (transform (shearing 0.0d0 0.0d0 0.0d0 0.0d0 0.0d0 1.0d0))
         )
    (ok (tup-eql (mul-tup transform p) (tuples:make-point 2.0d0 3.0d0 7.0d0)))
    )
  (let* ((p (tuples:make-point 1.0d0 0.0d0 1.0d0))
         (a (rotation_x (/ pi 2.0d0)))
         (b (scaling 5.0d0 5.0d0 5.0d0))
         (c (translation 10.0d0 5.0d0 7.0d0))
         (t1 (mul c (mul b a)))
         (p2 (mul-tup a p))
         (p3 (mul-tup b p2))
         (p4 (mul-tup c p3))
         )
    (ok (tup-eql p2 (tuples:make-point 1.0d0 -1.0d0 0.0d0)))
    (ok (tup-eql p3 (tuples:make-point 5.0d0 -5.0d0 0.0d0)))
    (ok (tup-eql p4 (tuples:make-point 15.0d0 0.0d0 7.0d0)))
    (ok (tup-eql (mul-tup t1 p) (tuples:make-point 15.0d0 0.0d0 7.0d0)))
    )
  )
